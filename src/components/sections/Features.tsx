...
const features = [
  {
    ...
    title: 'Trato amoroso',
    description: 'Sin jaulas ni estrés. Tratamos a cada mascota con la paciencia que tendríamos con la nuestra.',
  ...
  },
  {
    ...
    title: 'Profesionales',
    description: 'Estilistas certificados y en constante capacitación para garantizar la seguridad.',
  ...
  },
  {
    ...
    description: 'Cosmética hipoalergénica y libre de parabenos. Lo mejor para su piel.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature) => (
            ...
            >
              ...
              <h3 className={`text-xl font-semibold text-primary mb-3 tracking-tight ${feature.hoverTextClass} transition-colors`}>
                {feature.title}
              </h3>
              <p className="text-primary/60 font-light leading-relaxed text-sm">{feature.description}</p>
            </div>
          ))}
        </div>
      </div>
